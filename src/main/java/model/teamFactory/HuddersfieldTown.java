...
public class HuddersfieldTown implements Team {
    private String name;
    private String code;
    ...
    private String url = FootballAPI.URL + "/teams/394/";

    public HuddersfieldTown() {
    ...
    public HuddersfieldTown(JSONObject team){
